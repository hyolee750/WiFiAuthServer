        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href=""><i class="fa fa-shopping-cart"></i> <span>应用商店管理</span></a>
                    <ul class="sub-menu-list">
                        <li class="active"><a href="${pageContext.request.contextPath}/market/app/list"> 应用列表</a></li>
                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <a class="btn btn-post">装机必备</a>
                            <a class="btn btn-default">社交</a>
                            <a  class="btn btn-default">游戏</a>
                        </header>
                                ...
                                <div class="" id="home">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <section class="panel">
                                                <header class="panel-heading">
                                                   <i class="fa fa-download"></i> 装机必备
                                                    <span class="pull-right">
                                                        <button class="btn btn-success" onclick="addNewApp()">新增应用</button>
                                                    </span>
                                                </header>
                                                <div class="panel-body">
                                                    <div class="adv-table">
...
<%--弹出对话框，用来添加新的应用这里使用bootstrap的模态框来完成--%>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="categoryId" class="col-lg-2 col-sm-2 control-label">应用分类</label>
                                <div class="col-lg-10">
                                    <select name="categoryId" id="categoryId" class="form-control m-bot15">
                                        <option value="1">装机必备</option>
                            ...
                            <div class="form-group">
                                <label for="name" class="col-lg-2 col-sm-2 control-label">应用名称</label>
                                <div class="col-lg-10">
                                    <input type="password" class="form-control" id="name" placeholder="请输入应用名称...">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="icon" class="col-lg-2 col-sm-2 control-label">图标上传</label>
                                <div class="col-lg-10">
                                    <input type="file" id="icon" name="icon">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="apk" class="col-lg-2 col-sm-2 control-label" >应用上传</label>
                                <div class="col-lg-10">
                                    <input type="file" id="apk">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="description" class="col-lg-2 col-sm-2 control-label">应用介绍</label>
                                <div class="col-lg-10">
...
<!-- 删除应用弹出的警告框 -->
<div class="modal fade" id="removeAppModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
